...
license: MIT
metadata:
  author: Research Excellence Institute
  version: "1.0.0"
  category: research
...
| Domain | Requirements |
|--------|--------------|
| **Chinese History/Philosophy/Literature/Art** | Must retrieve English Sinology authoritative views (Shaughnessy, Nivison, Boltz, Kern, Lewis, Pines, Goldin via Google Scholar); Priority: *Cambridge History of China*, Brill series, *Early China* journal |
